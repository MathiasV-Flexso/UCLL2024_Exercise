		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#comflexmasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comflexmasterdetail-display": {
								"semanticObject": "comflexmasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.flex.masterdetail",
									"url": sap.ui.require.toUrl("com/flex/masterdetail")
								}
							}
						}
					}
